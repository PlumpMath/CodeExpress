(ns codeexpress.s-expression
  ...
  (:use [codeexpress globals util pushstate random individual evaluate]
        ...
        [codeexpress.pushgp breed parent-selection report]))
...
(def push-argmap
     (atom (sorted-map
             :program-representation :push ;s-expression
             :error-function (fn [p] '(0)) ;; pgm -> list of errors (1 per case)
             :error-threshold 0
...
(defn evolve
  "The top-level routine of evolve."
  ([] (evolve '()))
  ([args]
