...
(ns codeexpress.examples.pushgp.ultra-regression
  (:use codeexpress.pushgp.pushgp)
  (:require codeexpress.examples.pushgp.simple-regression))
...
(def argmap
  (merge codeexpress.examples.pushgp.simple-regression/argmap
