;; mux_6_lexicase_gsxover.clj
;; an example problem for codeexpress, a Push/PushGP system written in Clojure
;; Lee Spector, lspector@hampshire.edu, 2010-2012
;;
;; This is code for the 6-bit multiplexer problem. This code is identical
;; to the code in mux_6.clj except for the parameters to the pushgp call,
;; which here specify the use of lexicase selection and boolean gsxover
;; (along with related parameter changes).

(ns codeexpress.examples.pushgp.mux-6-lexicase-gsxover
